    ...
    return (
      ...
      >
        <DialogTitle id="alert-dialog-slide-title" className={classes.title}>
          {humanize(iconName, true)} ({iconCode})
        </DialogTitle>
        <DialogContent>
          <div className={classes.bigIcon}>
            <Icon className={classes.icon}>{iconName}</Icon>
          </div>
          <Typography variant="subheading" gutterBottom>Use with Font Icons</Typography>
          ...
          <Typography variant="subheading" gutterBottom>Use with SVG Material icons</Typography>
          <SyntaxHighlighter className={classes.code} language="jsx" style={themeSource}>
            {importCode}
          </SyntaxHighlighter>
          <SyntaxHighlighter className={classes.code} language="jsx" style={themeSource}>
